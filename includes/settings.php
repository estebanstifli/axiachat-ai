                    ...
                    <div class="row g-4">
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch" id="aichat_global_bot_enabled" name="aichat_global_bot_enabled" value="1" <?php checked($global_on); ?> />
                                        <label class="form-check-label" for="aichat_global_bot_enabled"><?php echo esc_html__( 'Enable global floating bot', 'aichat' ); ?></label>
                                        <div class="form-text"><?php echo esc_html__( 'Shortcode [aichat bot="..."] on a page suppresses the global bot there.', 'aichat' ); ?></div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="aichat_logging_enabled" name="aichat_logging_enabled" value="1" <?php checked( get_option('aichat_logging_enabled',1) ); ?> />
                                        <label class="form-check-label" for="aichat_logging_enabled"><?php echo esc_html__( 'Conversation logging', 'aichat' ); ?></label>
                                        <div class="form-text"><?php echo esc_html__( 'Disable to stop saving new messages (existing records remain).', 'aichat'); ?></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card shadow-sm mb-4">
                                    ...
                                    <div class="card-body">
                                        <?php $logging_on = (bool) get_option('aichat_logging_enabled',1); ?>
                                        <?php if ( ! $logging_on ): ?>
                                        ...
                                        <div class="form-check form-switch mb-3">
                                            ...
                                            <input class="form-check-input" type="checkbox" id="aichat_usage_limits_enabled" name="aichat_usage_limits_enabled" value="1" <?php checked( get_option('aichat_usage_limits_enabled',1) ); ?> />
                                            <label class="form-check-label" for="aichat_usage_limits_enabled"><?php echo esc_html__( 'Enable usage limits', 'aichat'); ?></label>
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label for="aichat_usage_max_daily_total" class="form-label fw-semibold"><?php echo esc_html__( 'Max messages per day (total)', 'aichat'); ?></label>
                                                <input type="number" min="0" class="form-control" id="aichat_usage_max_daily_total" name="aichat_usage_max_daily_total" value="<?php echo esc_attr( get_option('aichat_usage_max_daily_total',0) ); ?>" />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" min="0" class="form-control" id="aichat_usage_max_daily_per_user" name="aichat_usage_max_daily_per_user" value="<?php echo esc_attr( get_option('aichat_usage_max_daily_per_user',0) ); ?>" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="aichat_usage_per_user_message" name="aichat_usage_per_user_message" value="<?php echo esc_attr( get_option('aichat_usage_per_user_message','') ); ?>" />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <input type="text" class="form-control" id="aichat_usage_daily_total_message" name="aichat_usage_daily_total_message" value="<?php echo esc_attr( get_option('aichat_usage_daily_total_message','') ); ?>" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <input class="form-check-input" type="checkbox" id="aichat_gdpr_consent_enabled" name="aichat_gdpr_consent_enabled" value="1" <?php checked( get_option('aichat_gdpr_consent_enabled',0) ); ?> />
                                        <label class="form-check-label" for="aichat_gdpr_consent_enabled"><?php echo esc_html__( 'Enable consent gate', 'aichat' ); ?></label>
                                    </div>
                                    <div class="mb-3">
                                        <label for="aichat_gdpr_text" class="form-label fw-semibold"><?php echo esc_html__( 'Consent text', 'aichat' ); ?></label>
                                        <input type="text" class="form-control" id="aichat_gdpr_text" name="aichat_gdpr_text" value="<?php echo esc_attr( get_option('aichat_gdpr_text','') ); ?>" />
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control" id="aichat_gdpr_button" name="aichat_gdpr_button" value="<?php echo esc_attr( get_option('aichat_gdpr_button','') ); ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="aichat_moderation_enabled" name="aichat_moderation_enabled" value="1" <?php checked( get_option('aichat_moderation_enabled') ); ?> />
                                        <label class="form-check-label" for="aichat_moderation_enabled"><?php echo esc_html__('Enable moderation layer','aichat'); ?></label>
                                        <div class="form-text"><?php echo esc_html__('Checks IP/words and optionally external API before sending to AI.','aichat'); ?></div>
                                    </div>
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="aichat_moderation_external_enabled" name="aichat_moderation_external_enabled" value="1" <?php checked( get_option('aichat_moderation_external_enabled') ); ?> />
                                        <label class="form-check-label" for="aichat_moderation_external_enabled"><?php echo esc_html__('External moderation (OpenAI)','aichat'); ?></label>
                                        <div class="form-text"><?php echo esc_html__('Requires OpenAI API key (omni-moderation-latest).','aichat'); ?></div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="aichat_moderation_rejection_message" name="aichat_moderation_rejection_message" value="<?php echo esc_attr( get_option('aichat_moderation_rejection_message','') ); ?>" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="aichat_moderation_use_default_words" name="aichat_moderation_use_default_words" value="1" <?php checked( get_option('aichat_moderation_use_default_words',true) ); ?> />
                                            <label class="form-check-label" for="aichat_moderation_use_default_words"><?php echo esc_html__('Include base list in English','aichat'); ?></label>
                                        </div>
