# Test MCP Smithery Server - Tools List
# After initialize, we need to call tools/list
...
Write-Host "=== MCP Tools/List Test ===" -ForegroundColor Cyan
Write-Host ""
            ...
            if ($line -like "data: *") {
                ...
                try {
                    ...
                    if ($parsed.result.tools) {
                        Write-Host ""
                        Write-Host "=== TOOLS FOUND ===" -ForegroundColor Yellow
